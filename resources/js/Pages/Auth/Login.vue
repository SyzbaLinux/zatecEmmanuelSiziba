                ...
                <v-row class="d-flex align-center">
                    ...
                    <v-col cols="12" sm="6">
                        <v-form @submit.prevent="logIn()">
                            <v-card class="glass rounded-lg">
                                <v-card-title class="my-5 text-center">  Welcome to HarmonyHub</v-card-title>
                                ...
                                <div class="mx-5 mb-5">
                                    <v-btn :href="route('redirectToGoogle')" size="x-large" class="no-uppercase" block rounded color="black" variant="outlined">
