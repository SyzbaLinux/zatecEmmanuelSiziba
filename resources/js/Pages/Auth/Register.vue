    ...
    <v-container>
        <div class="rounded-lg">
           <v-row class="d-flex align-center">
                    <v-col cols="12" sm="6" v-if="$vuetify.display.smAndUp">
                        <img   height="500" src="/images/register.png"/>
                    </v-col>
                    <v-col cols="12" sm="6">
                        <v-form @submit.prevent="registerUser()">
                            <v-card class="glass">
                                <v-card-title  class="mt-5 text-center">  Create an Account</v-card-title>
                                    ...
                                    <v-row>
                                        <v-col cols="12" sm="6">
                                            <v-text-field
                                                ...
                                                :prepend-inner-icon="showPasswordPub ? 'ph-eye' : 'ph-eye-slash'"
                                                :type="showPasswordPub ? 'text' : 'password'"
                                                @click:prependInner="showPasswordPub = !showPasswordPub"
                                            />
                                        </v-col>
                                        <v-col cols="12" sm="6">
                                            <v-text-field
...
<!--                                            class=" "-->
<!--                                            v-model="form.terms"-->
<!--                                            :error-messages="$page.props.errors.terms"-->
<!--                                            label=""-->
<!--                                        />-->
<!--                                        <v-btn   class="no-uppercase mt-2" color="primary" variant="tonal">-->
<!--                                            Read  Terms of use.-->
<!--                                        </v-btn>-->
<!--                                    </div>-->
